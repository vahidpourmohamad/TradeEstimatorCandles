...
def plotOneMinutes():
    df = candleGetNobitex('50','ETHIRT','1')
    #print (df)
    o = df['o'].astype(float)
    h = df['h'].astype(float)
    #print(h)
    ...
    plot(fig, filename='ETHIRT1.html',auto_open=False)
    return



def plotFiftyMinutes():
    df = candleGetNobitex('50','ETHIRT','15')
    #print (df)
    o = df['o'].astype(float)
    h = df['h'].astype(float)
    #print(h)
    ...
    fig = dict(data=data, layout=layout)
    plot(fig, filename='ETHIRT15.html',auto_open=False)
    return

def plotFiveMinutes():
    df = candleGetNobitex('50','ETHIRT','5')
    #print (df)
    o = df['o'].astype(float)
    h = df['h'].astype(float)
    #print(h)
    ...
    fig = dict(data=data, layout=layout)
    plot(fig, filename='ETHIRT5.html',auto_open=False)
    return

def plotSixtyMinutes():
    df = candleGetNobitex('50','ETHIRT','30')
    #print (df)
    o = df['o'].astype(float)
    h = df['h'].astype(float)
    #print(h)
    ...
    fig = dict(data=data, layout=layout)
    plot(fig, filename='ETHIRT30.html',auto_open=False)
    return
